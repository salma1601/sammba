...
class LocalBistat(AFNICommand):
    ...
    >>> bistat.inputs.neighbourhood = ('SPHERE', 1.2)
    >>> bistat.inputs.pearson = 'NIFTI'
    >>> bistat.inputs.outputtype = 'NIFTI'
    >>> bistat.cmdline
    '3dLocalBistat -prefix functional_bistat.nii -nhhd 'SPHERE(1.2)' -stat pearson 'functional.nii' 'structural.nii'
